//
// Experimental usage of SVC calls
// See: https://yaya-cout.github.io/Nwagyu/reference/apps/syscalls.html
//
// See: https://github.com/numworks/epsilon/blob/master/ion/src/device/shared/drivers/svcall.h
//


#define SVC_RETURNING_VOID(code) \
  __asm__ volatile("svc %[immediate]" : : [immediate] "I"(code));
...
// SVCall 40 is unused for now
// SVCall 41 is unused for now
...
//
// Second svcall.h file
// https://github.com/numworks/epsilon/blob/master/ion/src/device/userland/drivers/svcall.h
//
